...
public class SummaryOfClassBusinessBean implements Serializable {
    ...
    public static List createBeanCollection() {
        List<SummaryOfClassBusinessBean> list = new ArrayList<SummaryOfClassBusinessBean>();
        SummaryOfClassBusinessBean claim = new SummaryOfClassBusinessBean();
